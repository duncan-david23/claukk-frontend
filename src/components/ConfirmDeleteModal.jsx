...
const ConfirmDeleteModal = () => {
  const { displayConfirmModal, setDisplayConfirmModal, confirmStatus, setConfirmStatus, targetDeleteId} = useInvoice()
  const [msg, setMsg] = useState('');


  const notify = () => toast.success('Record deleted, kindly refresh to see changes.');
   ...
   const handleConfirmDelete = async () => {
        ...
        try {
            ...
            const response = await axios.delete(`https://claukk-backend.onrender.com/api/users/invoice-details/deleteInvoice/${targetDeleteId}`, {
            headers: {
        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 bg-white z-10 p-6 border-b border-gray-100 flex justify-between items-center">
              <h1 className="text-2xl font-bold text-gray-800 text-center">Are You Sure Want To Delete This Invoice</h1>
              <button 
